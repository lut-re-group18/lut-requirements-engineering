...
[Figure 1MeetCall sign in screen 4]

[Figure 2 Meetcall link application with Google 5]

[Figure 3 MeetCall calendar view 6]

[Figure 4 MeetCall book a new meeting 6]

[Figure 5 MeetCall, join meeting 7]

[Figure 6 MeetCall, meeting view 8]

[Figure 7 MeetCall live support chat, administrator perspective 9]
...
Revision History
  ...
  **Name**           **Date**     **Reason For Changes**                       **Version**
  ...
  RE Team            17.10.2022   Document review & structural changes         0.6

  RE Team            15.10.2022   Rotation 3 -- adding content                 0.5

  RE Team            13.10.2022   Document review & changes                    0.4

  RE Team            10.10.2022   Rotation 1 & 2 -- creating first draft       0.3

  RE Team            08.10.2022   Deciding content, summary, rotational work   0.2

  Mika Raudaskoski   07.10.2022   Initial document created                     0.1
  ------------------ ------------ -------------------------------------------- -------------
...
The latest document available on the documentation web resource \"Releases\"-page has a document titled \"vision-and-scope.pdf\", which includes a diagram, \"c4-context-diagram.png\", that shows the significant relationships of the system. This diagram is not duplicated here since the most recent version is available on the \"Releases\"-page.
...
Figure ![][3]3 represents MeetCalls Calendar view. *From there, users can see all their synchronised events in their Google and Microsoft calendars.*
...
Figure ![][7]7represents the live support chat view where administrators can support different customers. The admin can send messages via the chat to the users and mark the issue resolved afterwards.
...
# Functional Requirements
  ...
  **Requirement status**   **Reference document**                                                                                                                                                                                             
  ...
  Approved                 Github issues [LRE#25,][] [LRE#38]                                                                                                                                                                                 
  ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  **Requirement status**   **Reference document**                                                                                                                                                                                                                      
  ...
  Approved                 Github issue [LRE#37]                                                                                                                                                                                                                       
  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

+------------------------+----------------------------------------------+-----------------------------------------------------------------------------------------------+---+
| **Requirement** **ID** | **Requirement name**                         | **Requirement description**                                                                   |   |
+========================+==============================================+===============================================================================================+===+
| REQ-5                  | Ability to access core meeting functionality | During the meeting:                                                                           |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Host can press the record button to start recording the meeting.                          |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Users can mute and unmute themselves.                                                     |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Users can enable camera.                                                                  |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Users can share their screen                                                              |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Allow/invite participants to enter the meeting                                            |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | After the meeting                                                                             |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Meeting is stored at 3^rd^ party application storage, where host can watch it afterwards. |   |
|                        |                                              |                                                                                               |   |
|                        |                                              | -   Host can decide who has the access to the recording                                       |   |
+------------------------+----------------------------------------------+-----------------------------------------------------------------------------------------------+---+
| **Release version**    | **Priority**                                 | **Verification steps**                                                                        |   |
+------------------------+----------------------------------------------+-----------------------------------------------------------------------------------------------+---+
...
The last category\'s use cases are not presented in the SRS documentation.
...
4.3.2 Stimulus/Response Sequences
  ...
  **Step**   **User Actions**                    **System Actions**
  ...
  1          User clicks to link their account   System acknowledges this, and offers the information about linking their Google account with MeetCall
             ...
             User accepts the linking            System links the users Google account and synchronizes the calendar
  ------------------------------------------------------------------------------------------------------------------------------------------------------
...
Appendix C: Pull Requests
  ...
  **\#**   **title**                                                          **branch name**
  ...
  [Figure 1MeetCall sign in screen 4]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317746
  [Figure 2 Meetcall link application with Google 5]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317747
  [Figure 3 MeetCall calendar view 6]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317748
  [Figure 4 MeetCall book a new meeting 6]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317749
  [Figure 5 MeetCall, join meeting 7]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317750
  [Figure 6 MeetCall, meeting view 8]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317751
  [Figure 7 MeetCall live support chat, administrator perspective 9]: https://lut.sharepoint.com/sites/o365Group18_RE/Shared%20Documents/General/Deliverables%20(final)/SRS.docx#_Toc117317752
  [1]: media/image1.png {width="6.699305555555555in" height="3.76875in"}
  [2]: media/image2.png {width="6.7in" height="3.76875in"}
  [3]: media/image3.png {width="6.7in" height="3.76875in"}
  [4]: media/image4.png {width="6.699305555555555in" height="3.76875in"}
  [5]: media/image5.png {width="6.7in" height="3.76875in"}
  [6]: media/image6.png {width="6.7in" height="3.76875in"}
  [7]: media/image7.png {width="6.7in" height="3.76875in"}
  [8]: media/image8.png {width="6.697916666666667in" height="3.7694444444444444in"}
  ...
  [LRE#39]: https://github.com/lut-re-group18/lut-requirements-engineering/issues/39
